...
|---------|-------|--------------|
| [`packages/crm`](packages/crm) | [CRM Schema Audit](packages/crm/skills/crm-schema-audit) | Full CRM data model audit — 30+ object types, properties, pipelines, limits, workflow connections, D3 ERD, fix plan |
| [`packages/crm`](packages/crm) | [Property Dependency Mapper](packages/crm/skills/property-dependency) | Map every custom property to Forms, Lists, and Workflows that reference it — identify what's safe to archive |
...
backup-FIX-*.json             # Generated by fix.js --execute (pre-fix backups)
dependency-data.json          # Generated by dependency.js
dependency-report.html        # Generated by dependency.js
```
